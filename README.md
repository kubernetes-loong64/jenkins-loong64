...
- [![kubernetesloong64/jenkins-loong64:2.574-jdk21](https://img.shields.io/docker/v/kubernetesloong64/jenkins-loong64/2.574-jdk21?arch=loong64&logo=docker&label=kubernetesloong64%2Fjenkins-loong64)](https://hub.docker.com/r/kubernetesloong64/jenkins-loong64/tags)
- [![kubernetesloong64/jenkins-loong64:2.574-jdk25](https://img.shields.io/docker/v/kubernetesloong64/jenkins-loong64/2.574-jdk25?arch=loong64&logo=docker&label=kubernetesloong64%2Fjenkins-loong64)](https://hub.docker.com/r/kubernetesloong64/jenkins-loong64/tags)
...
```shell
# Jenkins (debian 14)
docker pull kubernetesloong64/jenkins-loong64:2.574-jdk21
docker pull kubernetesloong64/jenkins-loong64:2.574-jdk25
...
docker run -d --name jenkins \
  ...
  kubernetesloong64/jenkins-loong64:2.574-jdk21
...
Push a branch named `loong64-<jenkins-version>` (e.g. `loong64-2.574`) to trigger a build.
