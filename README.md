...
```shell
# Jenkins (debian 14)
docker pull kubernetesloong64/jenkins-loong64:2.575-jdk21
...
docker run -d --name jenkins \
  ...
  kubernetesloong64/jenkins-loong64:2.575-jdk21
...
Push a branch named `loong64-<jenkins-version>` (e.g. `loong64-2.575`) to trigger a build.
